...
function AdminDashboard({
  ...
  const effectiveUserEmail = userEmail || getUserEmailByRole(userRole);
...
const handleModuleChange = (moduleId: string) => {
  ...
  const renderModule = () => {
    switch (activeModule) {
      case 'dashboard':
        return <DashboardGeneral metrics={metrics} loading={metricsLoading} onNavigate={handleModuleChange} userRole={userRole} userEmail={effectiveUserEmail} />;
           ...
           <div className="flex items-center gap-2 sm:gap-3">
             ...
             <div className="flex items-center gap-2 sm:gap-3">
               ...
               <div className="text-sm hidden md:block">
                 ...
                 <p className="text-gray-500 text-xs">{effectiveUserEmail}</p>
               </div>
             </div>
           </div>
         </header>
